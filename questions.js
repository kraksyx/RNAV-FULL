const questions = [
  ...
  },
  {
    ...
    "options": [
      "an azimuth transmitter at the approach end of the runway",
      "an elevation transmitter at the upwind end of the runway and two frequencies",
      ...
      "an elevation transmitter at the approach end of the runway",
      "an azimuth transmitter at the upwind end of the runway and a single frequency"
    ],
    "correct": 3
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      "A special precision DME",
      "operating in the SHF band",
  ...
  },
  {
    ...
    "options": [
      ...
      "There will be no Omni Bearing Selector knob",
      "as this function is automatic on this type of indicator"
    ],
    "correct": 0
  },
  {
    "question": "The phase difference between the VOR reference signal and the variable phase signal measured at an aircraft bearing 297\\u00ba (T) from a VOR, where the magnetic variation is 23E, is:",
    "options": [
      "320\\u00ba",
      "274\\u00ba",
      "297\\u00ba",
  ...
  {
    "question": "The indications of a VOR in an aircraft tracking towards a VOR are 075\\u00ba (M) TO and deviation indicator central. A co-located NDB shows 012\\u00ba relative. What are the drift and heading in \\u00ba(M)?",
    "options": [
      "12oS\\u00ba; 087",
      "12oP\\u00ba; 063",
      "12oS\\u00ba; 063",
  ...
  {
    "question": "A VOR is sited at position 58\\u00ba00 N 073\\u00ba00 W where the magnetic variation equals 32\\u00baW. An aircraft is located at position 56\\u00ba00 N 073\\u00ba00 W where the magnetic variation equals 28\\u00baW. The aircraft is on VOR radial:",
    "options": [
      "360",
      "208",
      "212",
  ...
  {
    "question": "At a range of 200 nm from a VOR, if there is an error of 1\\u00ba, how far off the centreline is the aircraft?",
    "options": [
      "3.5 nm",
      "1.75 nm",
      "7 nm",
  ...
  {
    "question": "An aircraft on a heading of 270\\u00ba (M) has 093 set on the OBS and TO indicated on the VOR L/R deviation indicator. The needle shows two dots fly left. The aircraft is on the:",
    "options": [
      "277 radial",
      "089 radial",
      "097 radial",
  ...
  },
  {
    ...
    "options": [
      ...
      "the relative bearing to the VOR",
      "as observed on the RMI",
      "will jump 20o",
  ...
  },
  {
    ...
    "options": [
      ...
      "The VDF unit is prepared to give you assistance during an approach to the airfield",
      "based on VDF bearings",
      "The service will be limited to bearings",
      "no positions will be given by the DF station"
    ],
    "correct": 2
  },
  {
    ...
    "options": [
      ...
      "63 MHz different from interrogation frequency",
  ...
  },
  {
    ...
    "options": [
      ...
      "If the 150 Hz modulations predominates",
      "the needle on the CDI moves to the right of centre",
  ...
  },
  {
    ...
    "options": [
      ...
      "They transmit low power signals",
      "which cannot be detected by the aeroplane\\u2019s receiver"
    ],
    "correct": 2
  },
  {
    ...
    "options": [
      ...
      "Night effect",
      "station interference and latitude error",
      "Night effect",
      "station interference and lack of a failure warning system",
      "Coastal refraction",
      "timing error and lack of a failure warning system"
    ],
    "correct": 2
  },
  {
  ...
  },
  {
    ...
    "options": [
      "Zero",
      "as quadrantal errors are not found on the RMI",
      "At a maximum",
      "At a minimum",
      "Zero",
      "as quadrantal errors affect only the VOR"
    ],
    "correct": 1
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      "50 nm range and are NON A2A",
      "Locators have 15 W power",
      "10-25 nm range and are NON A2A",
      "Locators have 5000 W power",
      "50 nm range and are NON A2A",
      "Locators have 5000 W power",
      "50 nm range and are NON A1A"
    ],
    "correct": 1
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      "the actual aircraft track over the ground",
      "which will coincide with the aircraft heading when there is zero drift",
  ...
  },
  {
    ...
    "options": [
      ...
      "When the actual winds match the forecast winds",
      "and the actual cruising Mach number is equal to the FMC calculated Mach number"
    ],
    "correct": 3
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      "Navigation database",
      "aircraft position and departure aerodrome",
      "Departure runway",
      "planned route and ETD"
    ],
    "correct": 1
  },
  {
  ...
  },
  {
    ...
    "options": [
      "provides X",
      "Y and Y co-ordinates and monitoring of the accuracy of the satellite data",
      "provides X",
      "Y",
      "Z and T co-ordinates and the constellation data",
  ...
  },
  {
    ...
    "options": [
      ...
      "another satellite will be selected",
      "so there will be no degradation of position",
  ...
  },
  {
    ...
    "options": [
      ...
      "satellite clock time and clock error",
      "ionospheric propagation information",
      "X",
      "Y and Z co-ordinates and corrections",
  ...
  },
  {
    ...
    "options": [
      "The aircraft is clear of personnel",
  ...
  },
  {
    ...
    "options": [
      ...
      "will be presented",
      "Two sets",
      "with separate frequency control",
  ...
  },
  {
    ...
    "options": [
      ...
      "The PRF increases",
      "the range counters count down from maximum..."
    ],
    "correct": 0
  },
  {
